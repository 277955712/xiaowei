...
$(function(){
	...
	$("#shipping_method .js-select li").click(function(){
		...
		switch($(this).attr("data-code")){
			case "merchant_distribution":
				...
				if(parseInt($(this).attr("data-is-logistics")) === 1) $("#select_express_company").slideDown(300);//物流公司显示
	...
	$("#paylist li").click(function(){
		...
		if(parseInt(merchant_distribution.attr("data-is-logistics")) === 1) $("#select_express_company").slideDown(300);//物流公司显示
...
function validationOrder(){
	...
	var merchant_distribution = $("#shipping_method .js-select li[data-code='merchant_distribution']");//商家配送
	if(merchant_distribution.children("a").hasClass("selected")){
		if(parseInt($("#express_company").val()) == -1 || merchant_distribution.attr("data-is-logistics") == '' || parseInt(merchant_distribution.attr("data-is-logistics")) == 0){
			$.msg("商家未设置物流公司");
			return false;
