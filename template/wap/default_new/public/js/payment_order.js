...
function validationOrder(){
	...
	if(parseInt($(".item-options[data-flag='distribution']").attr("data-select")) == 0){
		...
		if($(".mask-layer-control[data-flag='distribution']").attr("data-is-logistics") == '' || parseInt($(".mask-layer-control[data-flag='distribution']").attr("data-is-logistics")) == 0){
			express_company_select = -1;
		}
