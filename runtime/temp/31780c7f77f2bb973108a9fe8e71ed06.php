<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:39:"template/adminblue\Goods\goodsList.html";i:1504696847;s:28:"template/adminblue\base.html";i:1504000059;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:28:"template/admin\urlModel.html";i:1503280183;s:34:"template/adminblue\pageCommon.html";i:1504257500;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
.goodsCategory{width: 218px;height: 300px;border: 1px solid #CCCCCC;position: absolute;z-index: 100;background: #fff;right: 0;display: none;overflow-y: auto;top: 31px;}
...
.two{left: 220px;border-left:0;}
.three{left: 440px;width: 198px;border-left:0;}
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '</span></div></td></tr>';
					html += '<tr><td colspan="2" style="background: white;"><div><a class="a-pro-view-img" href="'+__URL('SHOP_MAIN/goods/goodsinfo?goodsid='+data["data"][i]["goods_id"])+'" target="_blank" style="height:70px;line-height:70px;text-align:center;"><img class="thumbnail-img"src="'+__IMG(data["data"][i]["pic_cover_micro"])+'">';
