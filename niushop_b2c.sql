...
-- Script date 2017-09-06 19:37:00
...
-- Table `niushop_1.14_biaozhun`.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table `niushop_1.14_biaozhun`.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table `niushop_1.14_biaozhun`.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table `niushop_1.14_biaozhun`.nc_cms_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account
--

-- Table `niushop_1.14_biaozhun`.ns_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_assistant_records
--

-- Table `niushop_1.14_biaozhun`.ns_account_assistant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_order_records
--

-- Table `niushop_1.14_biaozhun`.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table `niushop_1.14_biaozhun`.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table `niushop_1.14_biaozhun`.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table `niushop_1.14_biaozhun`.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table `niushop_1.14_biaozhun`.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table `niushop_1.14_biaozhun`.ns_account_withdraw_user_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute
--

-- Table `niushop_1.14_biaozhun`.ns_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute_value
--

-- Table `niushop_1.14_biaozhun`.ns_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_cart
--

-- Table `niushop_1.14_biaozhun`.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table `niushop_1.14_biaozhun`.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table `niushop_1.14_biaozhun`.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table `niushop_1.14_biaozhun`.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table `niushop_1.14_biaozhun`.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table `niushop_1.14_biaozhun`.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table `niushop_1.14_biaozhun`.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table `niushop_1.14_biaozhun`.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table `niushop_1.14_biaozhun`.ns_express_shipping does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping_items
--

-- Table `niushop_1.14_biaozhun`.ns_express_shipping_items does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_gift_grant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods
--

-- Table `niushop_1.14_biaozhun`.ns_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute
--

-- Table `niushop_1.14_biaozhun`.ns_goods_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_deleted
--

-- Table `niushop_1.14_biaozhun`.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table `niushop_1.14_biaozhun`.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table `niushop_1.14_biaozhun`.ns_goods_brand does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category
--

-- Table `niushop_1.14_biaozhun`.ns_goods_category does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category_block
--

-- Table `niushop_1.14_biaozhun`.ns_goods_category_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_comment
--

-- Table `niushop_1.14_biaozhun`.ns_goods_comment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_deleted
--

-- Table `niushop_1.14_biaozhun`.ns_goods_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_evaluate
--

-- Table `niushop_1.14_biaozhun`.ns_goods_evaluate does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_group
--

-- Table `niushop_1.14_biaozhun`.ns_goods_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku
--

-- Table `niushop_1.14_biaozhun`.ns_goods_sku does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_deleted
--

-- Table `niushop_1.14_biaozhun`.ns_goods_sku_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture
--

-- Table `niushop_1.14_biaozhun`.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table `niushop_1.14_biaozhun`.ns_goods_sku_picture_delete does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec
--

-- Table `niushop_1.14_biaozhun`.ns_goods_spec does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec_value
--

-- Table `niushop_1.14_biaozhun`.ns_goods_spec_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member
--

-- Table `niushop_1.14_biaozhun`.ns_member does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account
--

-- Table `niushop_1.14_biaozhun`.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table `niushop_1.14_biaozhun`.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table `niushop_1.14_biaozhun`.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table `niushop_1.14_biaozhun`.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table `niushop_1.14_biaozhun`.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table `niushop_1.14_biaozhun`.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table `niushop_1.14_biaozhun`.ns_member_gift does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table `niushop_1.14_biaozhun`.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table `niushop_1.14_biaozhun`.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table `niushop_1.14_biaozhun`.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table `niushop_1.14_biaozhun`.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table `niushop_1.14_biaozhun`.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table `niushop_1.14_biaozhun`.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table `niushop_1.14_biaozhun`.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table `niushop_1.14_biaozhun`.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table `niushop_1.14_biaozhun`.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table `niushop_1.14_biaozhun`.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table `niushop_1.14_biaozhun`.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table `niushop_1.14_biaozhun`.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table `niushop_1.14_biaozhun`.ns_pickup_point does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_adv
--

-- Table `niushop_1.14_biaozhun`.ns_platform_adv does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_platform_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend
--

-- Table `niushop_1.14_biaozhun`.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table `niushop_1.14_biaozhun`.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--

-- Table `niushop_1.14_biaozhun`.ns_point_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_discount_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_full_mail
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_full_mail does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table `niushop_1.14_biaozhun`.ns_promotion_mansong_rule does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_shop does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table `niushop_1.14_biaozhun`.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table `niushop_1.14_biaozhun`.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table `niushop_1.14_biaozhun`.ns_shop_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_group
--

-- Table `niushop_1.14_biaozhun`.ns_shop_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_navigation
--

-- Table `niushop_1.14_biaozhun`.ns_shop_navigation does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_shop_order_account_records does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.ns_supplier does not contain any data (it is empty)

-- 
-- Dumping data for table sys_addons
--

-- Table `niushop_1.14_biaozhun`.sys_addons does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_album_picture does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_custom_template does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_instance_type does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_notice_template does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_user does not contain any data (it is empty)

-- 
-- Dumping data for table sys_user_admin
--

-- Table `niushop_1.14_biaozhun`.sys_user_admin does not contain any data (it is empty)

-- 
-- Dumping data for table sys_user_group
--

-- Table `niushop_1.14_biaozhun`.sys_user_group does not contain any data (it is empty)

-- 
-- Dumping data for table sys_user_log
--

-- Table `niushop_1.14_biaozhun`.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table `niushop_1.14_biaozhun`.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table `niushop_1.14_biaozhun`.sys_version_patch does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_msg_template does not contain any data (it is empty)
...
-- Table `niushop_1.14_biaozhun`.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table `niushop_1.14_biaozhun`.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table `niushop_1.14_biaozhun`.sys_wexin_onekeysubscribe does not contain any data (it is empty)
